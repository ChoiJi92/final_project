  ...
  return (
    <Container>
      ...
      <Center search={search}>
        ...
        <div className="menu">
          <div style={{color: menu==='hotel' ? 'gray' : 'black'}} onClick={()=>{
            setMenu('hotel')
          }}>숙소 찾기</div>
          <div  style={{color: menu==='community' ? 'gray' : 'black'}} onClick={() => {
            setMenu('community')
            navigate("/community")}}>유저 커뮤니티</div>
          <div style={{color: menu==='chat' ? 'gray' : 'black'}} onClick={()=>{
            navigate('/chat')
            setMenu('chat')
          }}>오픈 채팅방</div>
        </div>
